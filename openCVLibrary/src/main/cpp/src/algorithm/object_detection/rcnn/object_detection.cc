...
ObjectDetect::ObjectDetect(const std::string &path_root):
    ...
    smoke_param = path_root + "/tiny_prelu2_smoking.param";
    smoke_model = path_root + "/tiny_prelu2_smoking.bin";
    call_param = path_root + "/tiny_prelu2_phone.param";
    call_model = path_root + "/tiny_prelu2_phone.bin";
    face_param = path_root + "/tiny_prelu2_face.param";
    face_model = path_root + "/tiny_prelu2_face.bin";
    cls_param = path_root + "/cls.param";
    cls_model = path_root + "/cls.bin";
