...
ObjectDetect::ObjectDetect(const std::string &path):
        index_(0) ,
    ...
    std::string arch = "/x86_64-collections";
//    std::string arch = "/aarch64-collections";
    std::string model_path = path + arch;
    
    std::string resize_module_path = model_path + "/resize_deploy/deploy.so";
    std::string resize_json_path = model_path + "/resize_deploy/deploy_graph.json";
    std::string resize_params_path = model_path + "/resize_deploy/deploy_param.params";

    std::string cls_module_path = model_path + "/cls_deploy/deploy.so";
    std::string cls_json_path = model_path + "/cls_deploy/deploy_graph.json";
    std::string cls_params_path = model_path + "/cls_deploy/deploy_param.params";

    std::string face_module_path = model_path + "/face_deploy/deploy.so";
    std::string face_json_path = model_path + "/face_deploy/deploy_graph.json";
    std::string face_params_path = model_path + "/face_deploy/deploy_param.params";

    std::string smoke_module_path = model_path + "/smoking_deploy/deploy.so";
    std::string smoke_json_path = model_path + "/smoking_deploy/deploy_graph.json";
    std::string smoke_params_path = model_path + "/smoking_deploy/deploy_param.params";

    std::string call_module_path = model_path + "/phone_deploy/deploy.so";
    std::string call_json_path = model_path + "/phone_deploy/deploy_graph.json";
    std::string call_params_path = model_path + "/phone_deploy/deploy_param.params";
    ...
    call_classify->InitModel(resize_module_path,resize_json_path,resize_params_path,
              ...
              cls_module_path,cls_json_path,cls_params_path,0.974f);
